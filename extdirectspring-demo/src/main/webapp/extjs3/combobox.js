Ext.onReady(function() {
      ...
      var tpl = new Ext.XTemplate('<tpl for=".">', '<div class="combo-result-item">', '<div class="combo-name">{fullName}</div>',
          '<div class="combo-full-address">{street}</div>', '<div class="combo-full-address">{city} {state} {zip}</div>', '</div></tpl>');
