...
public class ApiControllerTest {
	...
	public void testNoActionNamespaceDebug() throws IOException {
		...
		apiController.api("test", null, "TEST_REMOTING_API",
				"TEST_POLLING_URLS", null, false, null, request, response);
		compare(response, allApis(null), "test", "TEST_REMOTING_API",
				"TEST_POLLING_URLS");
		...
		ReflectionTestUtils.setField(routerController, "configuration",
				new Configuration());
	}
	...
	public void testWithActionNamespace() throws IOException {
		MockHttpServletRequest request = new MockHttpServletRequest("GET",
				"/action/api-debug.js");
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("Ext.ns", "actionns", "TEST_REMOTING_API",
				"TEST_POLLING_URLS", null, false, null, request, response);
		compare(response, allApis("actionns"), "Ext.ns", "TEST_REMOTING_API",
				"TEST_POLLING_URLS");
	...
	public void testUnknownGroup() throws IOException {
		...
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("test", null, "TEST_REMOTING_API",
				"TEST_POLLING_URLS", "xy", false, null, request, response);
		compare(response, noApis(null), "test", "TEST_REMOTING_API",
				"TEST_POLLING_URLS");
	...
	private void testGroup1(Configuration config) throws IOException {
		...
		compare(response, group1Apis("actionns"), "Ext.ns", "REMOTING_API",
				"POLLING_URLS", config);
	...
	public void testGroup2() throws IOException {
		...
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("test", null, "TEST_REMOTING_API",
				"TEST_POLLING_URLS", "group2", false, null, request, response);
		compare(response, group2Apis(null), "test", "TEST_REMOTING_API",
				"TEST_POLLING_URLS");
	...
	public void testGroup3() throws IOException {
		MockHttpServletRequest request = new MockHttpServletRequest("GET",
				"/action/api-debug.js");
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("Extns", "ns", "RAPI", "PURLS", "group3", false,
	...
	public void testGroup4() throws IOException {
		MockHttpServletRequest request = new MockHttpServletRequest("GET",
				"/action/api-debug.js");
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("test", "", "TEST_REMOTING_API", "TEST_POLLING_URLS",
				"group4", false, null, request, response);
		compare(response, group4Apis(null), "test", "TEST_REMOTING_API",
				"TEST_POLLING_URLS");

		request = new MockHttpServletRequest("GET", "/action/api.js");
		response = new MockHttpServletResponse();
		apiController.api("test", null, "TEST_REMOTING_API",
				"TEST_POLLING_URLS", "group4", false, null, request, response);
		compare(response, group4Apis(null), "test", "TEST_REMOTING_API",
				"TEST_POLLING_URLS");
	}
	...
	public void testGroup1and2() throws IOException {
		...
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("Ext.ns", "actionns", "REMOTING_API", "POLLING_URLS",
				"group1,group2", false, null, request, response);
		compare(response, group1and2Apis("actionns"), "Ext.ns", "REMOTING_API",
				"POLLING_URLS");
	...
	public void testGroup1andUnknown() throws IOException {
		...
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("Ext.ns", "actionns", "REMOTING_API", "POLLING_URLS",
				"group1,unknown", false, null, request, response);
		compare(response, group1Apis("actionns"), "Ext.ns", "REMOTING_API",
				"POLLING_URLS");
	...
	public void testInterfaceGroup() throws IOException {
		...
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("test", "", "TEST_REMOTING_API", "TEST_POLLING_URLS",
				"interface", false, null, request, response);
		compare(response, interfaceApis(null), "test", "TEST_REMOTING_API",
				"TEST_POLLING_URLS");

		request = new MockHttpServletRequest("GET", "/action/api.js");
		response = new MockHttpServletResponse();
		apiController.api("test", null, "TEST_REMOTING_API",
				"TEST_POLLING_URLS", "interface", false, null, request,
				response);
		compare(response, interfaceApis(null), "test", "TEST_REMOTING_API",
				"TEST_POLLING_URLS");
	}
	...
	public void testNoApiNs() throws IOException {
		MockHttpServletRequest request = new MockHttpServletRequest("GET",
				"/action/api-debug.js");
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("", "", "TEST_REMOTING_API", "TEST_POLLING_URLS",
				"group4", false, null, request, response);
		compare(response, group4Apis(null), null, "TEST_REMOTING_API",
				"TEST_POLLING_URLS");

		request = new MockHttpServletRequest("GET", "/action/api.js");
		response = new MockHttpServletResponse();
		apiController.api("", null, "TEST_REMOTING_API", "TEST_POLLING_URLS",
				"group4", false, null, request, response);
		compare(response, group4Apis(null), null, "TEST_REMOTING_API",
				"TEST_POLLING_URLS");
	}
	...
	public void testFullRouterUrl() throws IOException {
		MockHttpServletRequest request = new MockHttpServletRequest("GET",
				"/action/api-debug.js");
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("apiNs", "", "TEST_RMT_API", "TEST_POLL_URLS",
				"group2", true, null, request, response);
		compare(response,
				group2Apis(null, "http://localhost:80/action/router"), "apiNs",
				"TEST_RMT_API", "TEST_POLL_URLS");

		request = new MockHttpServletRequest("GET", "/action/api.js");
		response = new MockHttpServletResponse();
		apiController.api("apiNs", null, "TEST_RMT_API", "TEST_POLL_URLS",
				"group2", true, null, request, response);
		compare(response,
				group2Apis(null, "http://localhost:80/action/router"), "apiNs",
				"TEST_RMT_API", "TEST_POLL_URLS");
	...
	public void testFormat() throws IOException {
		...
		MockHttpServletResponse response = new MockHttpServletResponse();
		apiController.api("apiNs", "", "TEST_RMT_API", "TEST_POLL_URLS",
				"group2", false, "json", request, response);
		compareJson(response,
				group2Apis(null, "http://localhost:80/action/router"), "apiNs",
				"TEST_RMT_API");

		request = new MockHttpServletRequest("GET", "/action/api.js");
		response = new MockHttpServletResponse();
		apiController.api("", "ns", "TEST_RMT_API", "TEST_POLL_URLS", "group2",
				true, "json", request, response);
		compareJson(response,
				group2Apis("ns", "http://localhost:80/action/router"), "",
				"TEST_RMT_API");
	...
	static RemotingApi group1Apis(String namespace) {
		...
		remotingApi.addAction("remoteProviderSimple", new Action("method1", 0,
				false));
		remotingApi.addAction("remoteProviderTreeLoad", new Action("method1",
				1, false));
		return remotingApi;
	}
	...
	private static RemotingApi group2Apis(String namespace, String url) {
		...
		remotingApi.addAction("remoteProviderSimple", new Action("method5", 1,
				false));
		remotingApi.addAction("remoteProviderStoreRead", new Action("method6",
				1, false));
		remotingApi.addAction("remoteProviderStoreRead", new Action("method7",
				1, false));
		remotingApi.addAction("remoteProviderStoreModify", new Action(
				"update4", 1, false));
		remotingApi.addAction("remoteProviderStoreModifyInterface", new Action(
				"update4", 1, false));
		remotingApi.addAction("remoteProviderStoreModifySingle", new Action(
				"update4", 1, false));
		remotingApi.addAction("formInfoController", new Action("upload", 0,
				true));
	...
	private RemotingApi group3Apis(String namespace) {
		...
		remotingApi.addAction("remoteProviderSimple", new Action("method9", 0,
				false));
		remotingApi.addAction("remoteProviderStoreRead", new Action("method5",
				1, false));
		remotingApi.addAction("remoteProviderStoreModify", new Action(
				"destroy", 1, false));
		remotingApi.addAction("remoteProviderStoreModifySingle", new Action(
				"destroy", 1, false));
		remotingApi.addAction("remoteProviderFormLoad", new Action("method1",
				1, false));
		remotingApi.addAction("remoteProviderFormLoad", new Action("method5",
				1, false));
		remotingApi.addAction("formInfoController", new Action("updateInfo", 0,
				true));
		remotingApi.addAction("formInfoController2", new Action("updateInfo1",
				0, true));
		remotingApi.addAction("formInfoController2", new Action("updateInfo2",
				0, true));
		remotingApi.addAction("remoteProviderTreeLoad", new Action("method3",
				1, false));
		remotingApi.addPollingProvider(new PollingProvider("pollProvider",
	...
	private RemotingApi interfaceApis(String namespace) {
		RemotingApi remotingApi = new RemotingApi("/action/router", namespace);
		remotingApi.addAction("remoteProviderImplementation", new Action(
				"storeRead", 1, false));
		remotingApi.addAction("remoteProviderImplementation", new Action(
				"method2", 0, false));
		remotingApi.addAction("remoteProviderImplementation", new Action(
	...
	private RemotingApi allApis(String namespace) {
		...
		remotingApi.addAction("remoteProviderSimple", new Action("method11", 0,
				false));
		remotingApi.addAction("remoteProviderSimple", new Action("method11b",
				0, false));
		...
		remotingApi.addAction("remoteProviderStoreRead", new Action("method1",
				1, false));
		remotingApi.addAction("remoteProviderStoreRead", new Action("method2",
				1, false));
		remotingApi.addAction("remoteProviderStoreRead", new Action("method3",
				1, false));
		remotingApi.addAction("remoteProviderStoreRead", new Action("method4",
				1, false));
		remotingApi.addAction("remoteProviderStoreRead", new Action("method5",
				1, false));
		remotingApi.addAction("remoteProviderStoreRead", new Action("method6",
		...
		remotingApi.addAction("remoteProviderStoreRead", new Action("method7",
				1, false));
		remotingApi.addAction("remoteProviderStoreRead", new Action("method8",
				1, false));
		remotingApi.addAction("remoteProviderStoreRead", new Action(
				"methodFilter", 1, false));
		remotingApi.addAction("remoteProviderStoreRead", new Action(
				"methodMetadata", 1, false));
		...
		remotingApi.addAction("remoteProviderFormLoad", new Action("method1",
				1, false));
		remotingApi.addAction("remoteProviderFormLoad", new Action("method2",
				1, false));
		remotingApi.addAction("remoteProviderFormLoad", new Action("method3",
				1, false));
		remotingApi.addAction("remoteProviderFormLoad", new Action("method4",
				1, false));
		remotingApi.addAction("remoteProviderFormLoad", new Action("method5",
				1, false));
		remotingApi.addAction("remoteProviderFormLoad", new Action("method6",
				1, false));
		remotingApi.addAction("remoteProviderFormLoad", new Action("method7",
				1, false));
		...
		remotingApi.addAction("remoteProviderTreeLoad", new Action("method1",
				1, false));
		remotingApi.addAction("remoteProviderTreeLoad", new Action("method2",
				1, false));
		remotingApi.addAction("remoteProviderTreeLoad", new Action("method3",
				1, false));
		remotingApi.addAction("remoteProviderTreeLoad", new Action("method4",
				1, false));
		...
		remotingApi.addAction("remoteProviderSimpleNamed", new Action(
				"method2", Arrays.asList("i", "d", "s")));
		remotingApi.addAction("remoteProviderSimpleNamed", new Action(
				"method3", Arrays.asList("userName")));
		remotingApi.addAction("remoteProviderSimpleNamed", new Action(
				"method4", Arrays.asList("a", "b")));
		remotingApi.addAction("remoteProviderSimpleNamed", new Action(
				"method5", Arrays.asList("d")));
		remotingApi.addAction("remoteProviderSimpleNamed", new Action(
				"method6", new ArrayList()));
		remotingApi.addAction(
				"remoteProviderSimpleNamed",
				new Action("method7", Arrays.asList("flag", "aCharacter",
						"workflow", "aInt", "aLong", "aDouble", "aFloat",
						"aShort", "aByte")));
		remotingApi.addAction("remoteProviderSimpleNamed", new Action(
				"method9", Arrays.asList("aRow")));
		remotingApi.addAction(
				"remoteProviderSimpleNamed",
				new Action("method10", Arrays.asList("flag", "aCharacter",
						"workflow", "aInt", "aLong", "aDouble", "aFloat",
						"aShort", "aByte")));

		remotingApi.addAction(
				"remoteProviderSimpleNamed",
				new Action("method11", Arrays.asList("endDate",
						"normalParameter", "aDate", "percent")));

		remotingApi.addAction("remoteProviderSimpleNamed", new Action(
				"methodRP1", Arrays.asList("lastName", "theAge", "active")));
		remotingApi.addAction("remoteProviderSimpleNamed", new Action(
				"methodRP2", Arrays.asList("lastName", "theAge", "active")));
		remotingApi.addAction("remoteProviderSimpleNamed", new Action(
				"methodRP3", Arrays.asList("lastName", "theAge", "active")));
	...
	private void compareJson(MockHttpServletResponse response,
			RemotingApi remotingApi, String apiNs, String remotingApiVar)
		...
		Map<String, Object> rootAsMap = ControllerUtil.readValue(content,
				Map.class);
		...
		if (remotingApi.getNamespace() == null) {
			...
			assertThat(rootAsMap.get("namespace")).isEqualTo(
					remotingApi.getNamespace());
		}
		...
		Map<String, Object> beans = (Map<String, Object>) rootAsMap
				.get("actions");
		...
		for (String beanName : remotingApi.getActions().keySet()) {
			List<Map<String, Object>> actions = (List<Map<String, Object>>) beans
					.get(beanName);
			List<Action> expectedActions = remotingApi.getActions().get(
					beanName);
	...
	static void compare(MockHttpServletResponse response,
			RemotingApi remotingApi, String apiNs, String remotingApiVar,
			String pollingUrlsVar) throws JsonParseException,
			JsonMappingException, IOException {
		compare(response, remotingApi, apiNs, remotingApiVar, pollingUrlsVar,
				null);
	}

	static void compare(MockHttpServletResponse response,
			RemotingApi remotingApi, String apiNs, String remotingApiVar,
			String pollingUrlsVar, Configuration config)
			throws JsonParseException, JsonMappingException, IOException {
		String content = response.getContentAsString();
		...
		Map<String, Object> rootAsMap = ControllerUtil.readValue(remotingJson,
				Map.class);
		if (remotingApi.getNamespace() == null) {
		...
		if (!remotingApi.getPollingProviders().isEmpty()) {
			Map<String, Object> pollingMap = ControllerUtil.readValue(
					pollingJson, Map.class);
			assertThat(pollingMap).hasSize(
					remotingApi.getPollingProviders().size());
			for (PollingProvider pp : remotingApi.getPollingProviders()) {
				String url = (String) pollingMap.get(pp.getEvent());
				assertThat(url).isNotNull();
				assertEquals(String.format("%s/%s/%s/%s", remotingApi.getUrl()
						.replace("router", "poll"), pp.getBeanName(), pp
						.getMethod(), pp.getEvent()), url);
			}
		}
	}
	...
	private static void compare(List<Action> expectedActions,
		...
		for (Action expectedAction : expectedActions) {
			...
			if (expectedAction.isFormHandler() != null
