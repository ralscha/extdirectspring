...
public class RouterControllerSimpleNamedTest {
	...
	public void testNoParameters() {
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method1", "method1() called",
				null);
	}
	...
	public void testNonStrictMethod1() {
		...
		params.put("i", 23);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "nonStrictMethod1",
				"nonStrictMethod1() called-23-2.200-anotherString", params);
	}
	...
	public void testNonStrictMethod2() {
		...
		params.put("d", 2.2);
		params.put("i", 23);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "nonStrictMethod2",
				"nonStrictMethod2() called-23-2.200-null", params);
	}
	...
	public void testNonStrictMethod3() {
		...
		Map<String, Object> params = new LinkedHashMap<>();
		params.put("i", 17);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, headers, cookies, "remoteProviderSimpleNamed",
	...
	public void testWithParameters() {
		...
		params.put("i", 30);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method2",
	...
	public void testWithWrongParameters() {
		...
		params.put("de", 2.1);
		params.put("s", "aString");
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method2", null, params);
	}
	...
	public void testResultTrue() {
		...
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method3", Boolean.TRUE, params);
	}
	...
	public void testResultFalse() {
		...
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method3", Boolean.FALSE, params);
	}
	...
	public void testResultNull() {
		...
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method3", Void.TYPE, params);
	}
	...
	public void testIntParameterAndResult() {
		...
		params.put("a", 10);
		params.put("b", 20);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method4", 30, params);
	}
	...
	public void testIntParameterAndResultWithTypeConversion() {
		...
		params.put("b", "40");
		params.put("a", "30");
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method4", 70, params);
	}
	...
	public void testReturnsObject() {
		Map<String, Object> params = new LinkedHashMap<>();
		params.put("d", 7.34);
		FormInfo info = (FormInfo) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed",
				"method5", FormInfo.class, params);
	...
	public void testSupportedArguments() {
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method6", 42, null);
	}
	...
	public void testTypeConversion() {
		...
		params.put("aShort", "1");
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method7",
	...
	public void testMixParameterAndSupportedParameters() {
		...
		params.put("aShort", "1");
		params.put("aByte", "2");
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method10",
	...
	public void testTypeConversionWithObjects() {
		...
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "method9",
	...
	public void testCollections() {
		...
		TestObject ce = new TestObject(23, "Meier", Boolean.FALSE, new BigDecimal("100.23"));
		params.put("collections", Collections.singleton(ce));
		String result = (String) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed",
		...
		result = (String) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed",
				"methodCollection1", String.class, params);
		...
		params = new LinkedHashMap<>();
		params.put("name", "4");
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "methodCollection1", null,
				params);

		params = new LinkedHashMap<>();
		params.put("name", "4");
		result = (String) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed",
				"methodCollection2", String.class, params);
	...
	public void testCollectionsWithoutGeneric() {
		...
		TestObject ce = new TestObject(33, "Meier", Boolean.TRUE, new BigDecimal("33.334"));
		params.put("collections", Collections.singleton(ce));
		String result = (String) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed",
	...
	public void testArrays() {
		...
		result = (String) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "methodArray1",
				String.class, params);
		assertThat(result).isEqualTo(
		...
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "methodArray1", null, params);

		params = new LinkedHashMap<>();
		params.put("name", "arr4");
		result = (String) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "methodArray2",
				String.class, params);
	...
	public void testArraysEllipsis() {
		...
		TestObject ce = new TestObject(24, "Kiere", Boolean.FALSE, new BigDecimal("1001.23"));
		params.put("array", Collections.singleton(ce));
		String result = (String) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed",
		...
		params.put("array", list);
		result = (String) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "methodArray3",
				String.class, params);
		assertThat(result).isEqualTo(
		...
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "methodArray3", null, params);

		params = new LinkedHashMap<>();
		params.put("name", "arre4");
		result = (String) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderSimpleNamed", "methodArray4",
				String.class, params);
	...
	public void testDefaultValues() throws Exception {
		List<String> multiRequests = new ArrayList<>();
		...
		params.put("theAge", "33");
		params.put("active", Boolean.FALSE);
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP2", true, 3, params, null);
		multiRequests.add(edRequest);
		...
		params.put("lastName", "Olstead");
		params.put("active", Boolean.FALSE);
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP2", true, 4, params, null);
		multiRequests.add(edRequest);
		...
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP2", true, 5, params, null);
		multiRequests.add(edRequest);
		...
		params = new LinkedHashMap<>();
		params.put("active", Boolean.FALSE);
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP2", true, 6, params, null);
		multiRequests.add(edRequest);
		...
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP2", true, 7, params, null);
		multiRequests.add(edRequest);
		...
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP2", true, 8, params, null);
		multiRequests.add(edRequest);
		...
		params = new LinkedHashMap<>();
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP2", true, 9, params, null);
		multiRequests.add(edRequest);
	...
	public void testOptionalNoDefaultValue() throws Exception {
		...
		params.put("theAge", "33");
		params.put("active", Boolean.FALSE);
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP3", true, 3, params, null);
		multiRequests.add(edRequest);
		...
		params.put("lastName", "Olstead");
		params.put("active", Boolean.FALSE);
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP3", true, 4, params, null);
		multiRequests.add(edRequest);

		result = ControllerUtil.performRouterRequest(this.mockMvc, edRequest);
		responses = ControllerUtil.readDirectResponses(result.getResponse().getContentAsByteArray());
		assertResponse("remoteProviderSimpleNamed", "methodRP3", 4, new ResultObject("Olstead", null, Boolean.FALSE),
				responses);

		params = new LinkedHashMap<>();
		params.put("lastName", "Olstead");
		params.put("theAge", 36);
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP3", true, 5, params, null);
		multiRequests.add(edRequest);
		...
		params = new LinkedHashMap<>();
		params.put("active", Boolean.FALSE);
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP3", true, 6, params, null);
		multiRequests.add(edRequest);
		...
		params = new LinkedHashMap<>();
		params.put("lastName", "Miller");
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP3", true, 7, params, null);
		multiRequests.add(edRequest);
		...
		params = new LinkedHashMap<>();
		params.put("theAge", 55);
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP3", true, 8, params, null);
		multiRequests.add(edRequest);
		...
		params = new LinkedHashMap<>();
		edRequest = ControllerUtil.createEdsRequest("remoteProviderSimpleNamed", "methodRP3", true, 9, params, null);
		multiRequests.add(edRequest);
	...
	public void testCookie() {
		...
		params.put("i", 99L);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, cookies, "remoteProviderSimpleNamed", "withCookie",
				"99:ralph", params);

		params = new HashMap<>();
		params.put("i", 102L);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, null, "remoteProviderSimpleNamed", "withCookie",
				"102:defaultCookie", params);

		cookies = new ArrayList<>();
		cookies.add(new Cookie("aSimpleCookie", "ralph2"));
		params = new HashMap<>();
		params.put("i", 102L);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, cookies, "remoteProviderSimpleNamed",
				"withRequiredCookie", "102:ralph2", params);

		params = new HashMap<>();
		params.put("i", 102L);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, null, "remoteProviderSimpleNamed", "withRequiredCookie",
				null, params);
	}
	...
	public void testRequestHeader() {
		...
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, headers, null, "remoteProviderSimpleNamed",
				"withRequestHeader", "1.1:theHeaderValue", params);

		params = new HashMap<>();
		params.put("bd", new BigDecimal("1.2"));
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, null, "remoteProviderSimpleNamed", "withRequestHeader",
		...
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, null, "remoteProviderSimpleNamed",
