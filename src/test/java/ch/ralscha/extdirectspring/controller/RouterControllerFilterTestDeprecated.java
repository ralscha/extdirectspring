...
@Deprecated
public class RouterControllerFilterTestDeprecated {
	...
	public static void readJson() throws IOException {
		...
		InputStream is = RouterControllerFilterTestDeprecated.class.getResourceAsStream("/filterjson_deprecated.txt");
