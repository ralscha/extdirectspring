...
public class RouterControllerOptionalTest {
	...
	public void testMethod1() {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method1",
				"method1() called--1-3.100-requestParameter2", null, 3.1, "requestParameter2");

		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method1", "method1() called-2-3.141-str",
				2, null, "str");
	...
	public void testMethod2() {
		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method2", "one", "one");

		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method2", "default",
				new Object[] { null });
	}
	...
	public void testMethod4() throws Exception {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, headers, "remoteProviderOptional", "method4", "1;v;headerValue", 1,
				"v");
	}
	...
	public void testMethod5() throws Exception {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, headers, "remoteProviderOptional", "method5", "11;headerValue1",
				11);
	}
	...
	public void testMethod6a() throws Exception {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, headers, "remoteProviderOptional", "method6", "headerValue1");
	}

	@Test
	public void testMethod6b() throws Exception {
		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method6", "default");
	}
	...
	public void testMethod7a() throws Exception {
		HttpHeaders headers = new HttpHeaders();
		headers.add("header", "headerValue");
		ControllerUtil.sendAndReceiveWithSession(this.mockMvc, headers, "remoteProviderOptional", "method7",
				"headerValue");
	}

	@Test
	public void testMethod7b() throws Exception {
		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method7", "default");
	}
	...
	public void testMethod8a() throws Exception {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, headers, "remoteProviderOptional", "method8",
	...
	public void testMethod8c() throws Exception {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, headers, "remoteProviderOptional", "method8", "100;1st;2nd;last",
				100);
	}
	...
	public void testMethod9() throws Exception {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, headers, "remoteProviderOptional", "method9", "2;true");
		ControllerUtil.sendAndReceiveWithSession(this.mockMvc, headers, "remoteProviderOptional", "method9", "2;true");
	}
	...
	public void testMethod10And11() throws Exception {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method10", "Ralph;one-;11", "Ralph",
				new String[] { "one" }, 11);
		// ControllerUtil.sendAndReceive(mockMvc, "remoteProviderOptional", "method10",
		// "Ralph;;12", "Ralph", new String[] {}, 12);
		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method10", "Ralph;;13", "Ralph", null,
				13);
		...
		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method11", "aStr;3+;22", "aStr",
				new int[] { 3 }, 22);
		// ControllerUtil.sendAndReceive(mockMvc, "remoteProviderOptional", "method11",
		// "aStr;;23", "aStr", new int[] {}, 23);
		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method11", "aStr;;24", "aStr", null, 24);
	}
	...
	public void testMethod12And13() throws Exception {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method12", "Ralph;one-;11", "Ralph",
				new String[] { "one" }, 11);

		// ControllerUtil.sendAndReceive(mockMvc, "remoteProviderOptional", "method12",
		// "Ralph;;12", "Ralph", new String[] {}, 12);

		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method12", "Ralph;;13", "Ralph", null,
				13);

		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method13", "aStr;1+2+;20", "aStr", 20,
				new int[] { 1, 2 });

		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method13", "aStr;3+1+2+;21", "aStr", 21,
				new int[] { 3, 1, 2 });

		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method13", "aStr;3+;22", "aStr", 22,
				new int[] { 3 });

		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method13", "aStr;;23", "aStr", 23,
				new int[] {});

		ControllerUtil.sendAndReceive(this.mockMvc, "remoteProviderOptional", "method13", "aStr;;24", "aStr", 24, null);
	}
	...
	public void testMethod16() {
		...
		ControllerUtil.sendAndReceive(this.mockMvc, null, cookies, "remoteProviderOptional", "method16", "1;true",
				(Object[]) null);
		ControllerUtil.sendAndReceive(this.mockMvc, null, null, "remoteProviderOptional", "method16", "-1;false",
				(Object[]) null);
	}

	@Test
	public void testMethod17() {
		ControllerUtil.sendAndReceive(this.mockMvc, null, null, "remoteProviderOptional", "method17", "theDefaultValue",
				(Object[]) null);
	...
	public void testMethod18() {
		ControllerUtil.sendAndReceive(this.mockMvc, null,
				Collections.singletonList(new Cookie("nameOfTheCookie", "cookieValue")), "remoteProviderOptional",
				"method18", "cookieValue", (Object[]) null);
		ControllerUtil.sendAndReceive(this.mockMvc, null, null, "remoteProviderOptional", "method18", "default",
				(Object[]) null);
	}
	...
	public void testMethod19() {
		ControllerUtil.sendAndReceive(this.mockMvc, null,
				Collections.singletonList(new Cookie("stringCookie", "aString")), "remoteProviderOptional", "method19",
				"aString", (Object[]) null);
		ControllerUtil.sendAndReceive(this.mockMvc, null, null, "remoteProviderOptional", "method19", Void.TYPE,
				(Object[]) null);
	}
	...
	public void testPoll1a() throws Exception {
		...
		ExtDirectPollResponse resp = ControllerUtil.performPollRequest(this.mockMvc, "remoteProviderOptional", "opoll1",
				"opoll1", params, null);
	...
	public void testPoll2a() throws Exception {
		...
		ExtDirectPollResponse resp = ControllerUtil.performPollRequest(this.mockMvc, "remoteProviderOptional", "opoll2",
				"opoll2", params, null);
		assertThat(resp).isNotNull();
		assertThat(resp.getType()).isEqualTo("event");
	...
	public void testPoll3a() throws Exception {
		...
		ExtDirectPollResponse resp = ControllerUtil.performPollRequest(this.mockMvc, "remoteProviderOptional", "opoll3",
				"opoll3", params, null);
	...
	public void testPoll4() throws Exception {
		...
		ExtDirectPollResponse resp = ControllerUtil.performPollRequest(this.mockMvc, "remoteProviderOptional", "opoll4",
				"opoll4", null, headers);
	...
	public void testPoll5() throws Exception {
		...
		ExtDirectPollResponse resp = ControllerUtil.performPollRequest(this.mockMvc, "remoteProviderOptional", "opoll5",
	...
	public void testNamed1() {
		...
		params.put("i", 30);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderOptional", "namedMethod1",
		...
		params.put("d", "3.141");
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderOptional", "namedMethod1",
				"namedMethod1() called-30-3.141-100.45", params);
		...
		params = new HashMap<>();
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderOptional", "namedMethod1",
				"namedMethod1() called--1-3.141-default", params);
	}
	...
	public void testNamed2() {
		...
		ResultObject result = (ResultObject) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderOptional",
				"namedMethod2", ResultObject.class, params);
		...
		params.put("lastName", expectedResult.getName());
		params.put("active", expectedResult.getActive());
		result = (ResultObject) ControllerUtil.sendAndReceiveNamed(this.mockMvc, "remoteProviderOptional",
				"namedMethod2", ResultObject.class, params);
		assertThat(result).isEqualTo(expectedResult);
	...
	public void testNamed3() {
		...
		Map<String, Object> params = new HashMap<>();
		params.put("i", 99L);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, cookies, "remoteProviderOptional", "namedMethod3",
				"99:ralph", params);

		params = new HashMap<>();
		params.put("i", 101L);
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, null, "remoteProviderOptional", "namedMethod3",
				"101:defaultCookieValue", params);

		params = new HashMap<>();
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, null, "remoteProviderOptional", "namedMethod3",
				"100:defaultCookieValue", params);
	}
	...
	public void testNamed4() {
		...
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, headers, null, "remoteProviderOptional", "namedMethod4",
				"1.1:theHeaderValue", params);

		params = new HashMap<>();
		params.put("bd", new BigDecimal("1.2"));
		ControllerUtil.sendAndReceiveNamed(this.mockMvc, null, null, "remoteProviderOptional", "namedMethod4",
	...
	public void testStoreRead1() {
		...
		ExtDirectStoreResult<Row> storeResponse = (ExtDirectStoreResult<Row>) ControllerUtil.sendAndReceive(
				this.mockMvc, "remoteProviderOptional", "storeRead1", new TypeReference<ExtDirectStoreResult<Row>>() {
					// nothing here
				}, readRequest);
		...
		storeResponse = (ExtDirectStoreResult<Row>) ControllerUtil.sendAndReceive(this.mockMvc,
				"remoteProviderOptional", "storeRead1", new TypeReference<ExtDirectStoreResult<Row>>() {
					// nothing here
				}, readRequest);
	...
	public void testStoreRead2() {
		...
		ExtDirectStoreResult<Row> storeResponse = (ExtDirectStoreResult<Row>) ControllerUtil.sendAndReceive(
				this.mockMvc, headers, cookies, "remoteProviderOptional", "storeRead2",
		...
		storeResponse = (ExtDirectStoreResult<Row>) ControllerUtil.sendAndReceive(this.mockMvc,
				"remoteProviderOptional", "storeRead2", new TypeReference<ExtDirectStoreResult<Row>>() {
					// nothing here
				}, readRequest);
	...
	public void testTreeLoad1() {
		...
		List<Node> nodes = (List<Node>) ControllerUtil.sendAndReceive(this.mockMvc, false, null, cookies, null,
		...
		nodes = (List<Node>) ControllerUtil.sendAndReceive(this.mockMvc, false, null, cookies, null,
				"remoteProviderOptional", "treeLoad1", false,
				new TypeReference<List<Node>>() {/* nothinghere */
				}, requestParameters);
	...
	public void testTreeLoad2() {
		...
		List<Node> nodes = (List<Node>) ControllerUtil.sendAndReceive(this.mockMvc, headers, "remoteProviderOptional",
