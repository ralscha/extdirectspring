...
public class RouterControllerStoreModifyTest {
	...
	public void testCreateWithDataSingle() throws IOException {
		Row row = (Row) ControllerUtil.sendAndReceive(controller,
				"remoteProviderStoreModifySingle", "create1", new Row(10,
						"Ralph", true, "109.55"), Row.class);
	...
	public void testCreateWithDataAndSupportedArgumentsSingle()
			throws IOException {
		Row row = (Row) ControllerUtil.sendAndReceive(controller,
				"remoteProviderStoreModifySingle", "create2", new Row(10,
						"Ralph", false, "109.55"), Row.class);
		assertThat(row.getId()).isEqualTo(10);
	}
	...
	public void testUpdateSingle() throws IOException {
		...
		executeUpdate("remoteProviderStoreModifySingle", storeRequest,
				"update1");
	}
	...
	private void executeUpdate(String action, Map<String, Object> storeRequest,
		...
		if (result instanceof List) {
			...
			assertThat(storeResponse.getSalary()).isEqualTo(
					new BigDecimal("109.55"));
		}
	}
	...
	public void testDestroy() throws IOException {
		...
		List<Integer> rows = (List<Integer>) ControllerUtil.sendAndReceive(
				controller, "remoteProviderStoreModify", "destroy",
	...
	public void testDestroySingle() throws IOException {
		ControllerUtil.sendAndReceive(controller,
				"remoteProviderStoreModifySingle", "destroy",
				new Object[] { 1 }, 1);
	}
