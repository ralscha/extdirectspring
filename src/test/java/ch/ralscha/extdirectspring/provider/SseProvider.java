...
public class SseProvider {
	...
	@ExtDirectMethod(value = ExtDirectMethodType.SSE, event = "message1", group = "group2")
	...
	@ExtDirectMethod(value = ExtDirectMethodType.SSE, group = "group2", entryClass = String.class)
	public SSEvent message2(HttpServletResponse response, HttpServletRequest request, HttpSession session, Locale locale) {
	...
	public int message4(@RequestParam(value = "id", defaultValue = "1") int id, HttpServletRequest request) {
		assertThat(request).isNotNull();
		return id * 2;
	}

	@ExtDirectMethod(value = ExtDirectMethodType.SSE, group = "group3")
	public Integer message5(@RequestParam(value = "id", required = false) Integer id, String dummy) {
	...
	public SSEvent message7(@RequestParam(value = "id", required = false) Integer id, String dummy,
	...
	@ExtDirectMethod(value = ExtDirectMethodType.SSE, group = "group5", synchronizeOnSession = true)
	public SSEvent message8(@RequestParam Integer id,
	...
	@ExtDirectMethod(value = ExtDirectMethodType.SSE, group = "group5")
	public SSEvent message9(@RequestHeader(value = "anotherName", defaultValue = "default") String header) {
		SSEvent event = new SSEvent();
	...
	@ExtDirectMethod(value = ExtDirectMethodType.SSE, group = "group5")
	public SSEvent message10(@RequestHeader(defaultValue = "default", required = false) String header) {
		SSEvent event = new SSEvent();
	...
	@ExtDirectMethod(value = ExtDirectMethodType.SSE, group = "group5")
	public SSEvent message11(@RequestHeader(defaultValue = "default1", required = false) String header1,
	...
	@ExtDirectMethod(value = ExtDirectMethodType.SSE, group = "group5")
	public SSEvent message12(@RequestHeader Integer intHeader, @RequestHeader Boolean booleanHeader) {
		SSEvent event = new SSEvent();
