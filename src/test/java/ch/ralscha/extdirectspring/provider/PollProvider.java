...
public class PollProvider {
	...
	public String handleMessage3(Locale locale, @RequestParam(value = "id")
	int id) {
		assertThat(locale).isEqualTo(Locale.ENGLISH);
		return "Result: " + id;
	}
	...
	public int handleMessage4(@RequestParam(value = "id", defaultValue = "1")
	...
	public Integer handleMessage5(@RequestParam(value = "id", required = false)
	Integer id, String dummy) {
	...
	public String message7(@RequestParam(value = "id", required = false)
	Integer id, String dummy, @RequestHeader
	String header) {
		return id + ";" + dummy + ";" + header;
	}

	@ExtDirectMethod(value = ExtDirectMethodType.POLL, group = "group5", synchronizeOnSession = true)
	public String message8(@RequestParam
	Integer id, @RequestHeader("anotherName")
	String header) {
		return id + ";" + header;
	}

	@ExtDirectMethod(value = ExtDirectMethodType.POLL, group = "group5")
	public String message9(@RequestHeader(value = "anotherName", defaultValue = "default")
	String header) {
		return header;
	}

	@ExtDirectMethod(value = ExtDirectMethodType.POLL, group = "group5")
	public String message10(@RequestHeader(defaultValue = "default", required = false)
	String header) {
		return header;
	}

	@ExtDirectMethod(value = ExtDirectMethodType.POLL, group = "group5")
	public String message11(@RequestHeader(defaultValue = "default1", required = false)
	String header1, @RequestParam(value = "id", required = false)
	Integer id, @RequestHeader(defaultValue = "default2", required = false)
	...
	@ExtDirectMethod(value = ExtDirectMethodType.POLL, group = "group5")
	public String message12(@RequestHeader
