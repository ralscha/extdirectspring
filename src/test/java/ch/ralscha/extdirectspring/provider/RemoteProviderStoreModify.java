...
public class RemoteProviderStoreModify {
	...
	public List<Row> create2(List<Row> rows, HttpServletResponse response, final HttpServletRequest request,
	...
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY)
	public List<Row> update2(Locale locale, @RequestParam(value = "id") final int id, List<Row> rows) {
	...
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY)
	public List<Row> update3(List<Row> rows, @RequestParam(value = "id", defaultValue = "1") final int id,
