...
public class RemoteProviderMetadata {
	...
	public ExtDirectStoreResult<Row> method1(ExtDirectStoreReadRequest request, Locale locale,
		...
		return RemoteProviderStoreRead.createExtDirectStoreResult(request, ":" + id + ";" + mp + ";" + locale);
	}

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "metadata")
	public ExtDirectStoreResult<Row> method2(@MetadataParam(value = "id", defaultValue = "1") int id,
			final HttpServletRequest servletRequest, ExtDirectStoreReadRequest request) {
		assertThat(id).isEqualTo(1);
		assertThat(servletRequest).isNotNull();
		return RemoteProviderStoreRead.createExtDirectStoreResult(request, ":" + id + ";" + (servletRequest != null));
	}
	...
	public EdStoreResult<?> method1Ed(ExtDirectStoreReadRequest request, Locale locale,
		...
		return RemoteProviderStoreRead.createEdStoreResult(request, ":" + id + ";" + mp + ";" + locale, null);
	}

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "metadata")
	public EdStoreResult<?> method2Ed(@MetadataParam(value = "id", defaultValue = "1") int id,
			final HttpServletRequest servletRequest, ExtDirectStoreReadRequest request) {
		assertThat(id).isEqualTo(1);
		assertThat(servletRequest).isNotNull();
		return RemoteProviderStoreRead.createEdStoreResult(request, ":" + id + ";" + (servletRequest != null), null);
	}
	...
	public ExtDirectStoreResult<Row> method5(ExtDirectStoreReadRequest request, Locale locale,
			@MetadataParam(value = "id", required = false, defaultValue = "20") Integer id) {
	...
	public EdStoreResult<?> method6Ed(ExtDirectStoreReadRequest request, Locale locale,
		...
		return RemoteProviderStoreRead.createEdStoreResult(request, ":" + i + ";" + locale, null);
	}

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "metadata")
	public List<Row> update1(Locale locale, @MetadataParam(value = "id") int id, List<Row> rows) {
		assertThat(id).isEqualTo(10);
		assertThat(locale).isEqualTo(Locale.ENGLISH);
		return rows;
	}
	...
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "metadata")
	public List<Row> update2(List<Row> rows, @MetadataParam(value = "id", defaultValue = "1") int id,
	...
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "metadata")
	public List<Row> update3(List<Row> rows, @MetadataParam(value = "id") Optional<Integer> id,
			final HttpServletRequest servletRequest) {
	...
	public List<Node> treeLoad1(@RequestParam("node") String node,
			@RequestParam(defaultValue = "defaultValue") String foo, @MetadataParam(value = "id") Integer id) {
	...
	public List<Node> treeLoad3(@RequestParam("node") String node,
		...
		return RemoteProviderTreeLoad.createTreeList(node, ":" + foo + ";" + id.orElse(23));
	}
